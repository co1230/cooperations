...
const DoubleTapGestureHandler = /*@__PURE__*/ defineContainer('taro-double-tap-gesture-handler-core', defineCustomElementTaroDoubleTapGestureHandlerCore);
const DraggableSheet = /*@__PURE__*/ defineContainer('taro-draggable-sheet-core', defineCustomElementTaroDraggableSheetCore);
...
const ForcePressGestureHandler = /*@__PURE__*/ defineContainer('taro-force-press-gesture-handler-core', defineCustomElementTaroForcePressGestureHandlerCore);
...
const GridBuilder = /*@__PURE__*/ defineContainer('taro-grid-builder-core', defineCustomElementTaroGridBuilderCore);
const GridView = /*@__PURE__*/ defineContainer('taro-grid-view-core', defineCustomElementTaroGridViewCore);
const HorizontalDragGestureHandler = /*@__PURE__*/ defineContainer('taro-horizontal-drag-gesture-handler-core', defineCustomElementTaroHorizontalDragGestureHandlerCore);
...
const ListBuilder = /*@__PURE__*/ defineContainer('taro-list-builder-core', defineCustomElementTaroListBuilderCore);
...
const LongPressGestureHandler = /*@__PURE__*/ defineContainer('taro-long-press-gesture-handler-core', defineCustomElementTaroLongPressGestureHandlerCore);
...
const NestedScrollBody = /*@__PURE__*/ defineContainer('taro-nested-scroll-body-core', defineCustomElementTaroNestedScrollBodyCore);
const NestedScrollHeader = /*@__PURE__*/ defineContainer('taro-nested-scroll-header-core', defineCustomElementTaroNestedScrollHeaderCore);
const OfficialAccount = /*@__PURE__*/ defineContainer('taro-official-account-core', defineCustomElementTaroOfficialAccountCore);
const OpenContainer = /*@__PURE__*/ defineContainer('taro-open-container-core', defineCustomElementTaroOpenContainerCore);
const OpenData = /*@__PURE__*/ defineContainer('taro-open-data-core', defineCustomElementTaroOpenDataCore);
const OpenEmbeddedAtomicservice = /*@__PURE__*/ defineContainer('taro-open-embedded-atomicservice-core', defineCustomElementTaroOpenEmbeddedAtomicserviceCore);
...
const PanGestureHandler = /*@__PURE__*/ defineContainer('taro-pan-gesture-handler-core', defineCustomElementTaroPanGestureHandlerCore);
...
const ScaleGestureHandler = /*@__PURE__*/ defineContainer('taro-scale-gesture-handler-core', defineCustomElementTaroScaleGestureHandlerCore);
const Script = /*@__PURE__*/ defineContainer('taro-script-core', defineCustomElementTaroScriptCore);
...
const Span = /*@__PURE__*/ defineContainer('taro-span-core', defineCustomElementTaroSpanCore);
...
const TapGestureHandler = /*@__PURE__*/ defineContainer('taro-tap-gesture-handler-core', defineCustomElementTaroTapGestureHandlerCore);
...
const VerticalDragGestureHandler = /*@__PURE__*/ defineContainer('taro-vertical-drag-gesture-handler-core', defineCustomElementTaroVerticalDragGestureHandlerCore);
