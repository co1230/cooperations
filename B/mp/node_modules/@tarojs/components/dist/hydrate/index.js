...
class Button {
  ...
  render() {
    ...
    return (hAsync(Host, { class: cls, type: type, plain: plain, loading: loading, size: size }, loading && hAsync("i", { class: 'weui-loading' }), hAsync("slot", null)));
  }
  ...
  static get cmpMeta() { return {
    ...
    "$lazyBundleId$": "-",
    "$attrsToReflect$": [["disabled", "disabled"], ["formType", "form-type"]]
  }; }
}
...
class OpenEmbeddedAtomicservice {
  constructor(hostRef) {
    registerInstance(this, hostRef);
  }
  componentDidLoad() {
  ...
  static get cmpMeta() { return {
    "$flags$": 0,
    "$tagName$": "taro-open-embedded-atomicservice-core",
    "$members$": undefined,
    "$listeners$": undefined,
    "$lazyBundleId$": "-",
    "$attrsToReflect$": []
