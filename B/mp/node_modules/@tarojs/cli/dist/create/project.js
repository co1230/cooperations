...
function resolveProjectConf(conf) {
    if (!conf.projectName || !/^\.(?:[\\/])?$/.test(conf.projectName))
        return conf;
    ...
    return Object.assign(Object.assign({}, conf), { projectDir: path.dirname(projectDir), projectName: currentDirName, initInCurrentDir: true });
}
class Project extends creator_1.default {
    constructor(options) {
        ...
        this.askBuildEs5 = function (conf, prompts) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (typeof conf.ask === 'function') {
                    const { ask } = conf, other = __rest(conf, ["ask"]);
                    yield ask(Object.assign(Object.assign({}, other), { templatePath: this.templatePath(templateChoiceAnswer.template) }));
                }
            }
            catch (e) {
                console.error(e);
